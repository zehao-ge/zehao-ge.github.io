  ...
  return (
    <footer id="contact" className="section footer-section">
      <div className="content-width">
        ...
        <div className="profile-links">{site.contact.profiles.map((profile) => <a className="text-link" href={profile.href} target={profile.href.startsWith("http") ? "_blank" : undefined} rel={profile.href.startsWith("http") ? "noopener noreferrer" : undefined} key={profile.label}>{profile.label}</a>)}</div>
