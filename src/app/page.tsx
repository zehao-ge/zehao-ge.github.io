    ...
    <>
      ...
      <main id="main-content">
        ...
        <section id="publications" className="section" aria-labelledby="publications-title">
          <div className="site-container"><Reveal><h2 id="publications-title">{site.publications.heading}</h2></Reveal><Reveal><PublicationEntry /></Reveal></div>
        </section>
        <section id="experience" className="section" aria-labelledby="experience-title">
          <div className="site-container"><Reveal><h2 id="experience-title">{site.experience.heading}</h2></Reveal><Reveal><Timeline items={site.experience.items} /></Reveal></div>
        </section>
        ...
        <section id="awards" className="section" aria-labelledby="awards-title">
          <div className="site-container"><Reveal><h2 id="awards-title">{site.awards.heading}</h2></Reveal><Reveal><AwardGrid items={site.awards.items} /></Reveal></div>
        </section>
        <section id="skills" className="section" aria-labelledby="skills-title">
          <div className="site-container"><Reveal><h2 id="skills-title">{site.skills.heading}</h2></Reveal><Reveal><SkillPills groups={site.skills.groups} /></Reveal></div>
        </section>
      </main>
    </>
  );
